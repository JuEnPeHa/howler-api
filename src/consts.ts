...
export const MAP_AVAILABLE_IDS = initialMap();
...
export const makeBuy = (amount: number, price: number): Map<number, number> => {
    console.log(`makeBuy: amount: ${amount}, price: ${price}, MAP_AVAILABLE_IDS: ${MAP_AVAILABLE_IDS.values.length}`);
